...
setup(
  ...
  description = 'Use deep learning to predict whether a domain name is genuine or DGA.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/sudo-rushil/dgaintel/archive/v0.8.tar.gz',    # I explain this later on
